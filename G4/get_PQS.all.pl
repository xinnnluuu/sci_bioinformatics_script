#!/usr/bin/perl
#
#It's a script to analysis PQS in fasta sequencce. It's the transcriptome version. PQS type output DO NOT follow prority rules. Result region should be merged. 
